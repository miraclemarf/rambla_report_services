...
class M_Horeca extends CI_Model
{
   ...
   public function setRedisHappyFreshSales() {
        ...
        $dbCentral->select([
            ...
            'SUB_DIVISION',
            'DEPT', 'SUB_DEPT',
            'vs.article_code', 'barcode',
            'brand_code', 'brand_name', 'article_name', 'price',
            'ms.member_name', 'tot_qty', 'tot_berat', 'disc_pct', 'total_disc_amt',
            'moredisc_pct', 'total_moredisc_amt', 'net_af as "net"', 'gross'
        ]);
