<?php
    ...
    class M_Datatables extends CI_Model
    {
        ...
        function get_tables_where($tables,$cari,$where,$iswhere)
        {
            ...
            if(!empty($iswhere)){
                $sql = $this->db->query("SELECT * FROM ".$tables." WHERE 1=1 $iswhere AND ".$fwhere);
            }else{
            ...
            if(!empty($iswhere)){
                $sql_data = $this->db->query("SELECT * FROM ".$query." WHERE 1=1 $iswhere AND ".$fwhere." AND (".$cari.")".$order." LIMIT ".$limit." OFFSET ".$start);
            }else{
            ...
            {
                if(!empty($iswhere)){
                    $sql_cari =  $this->db->query("SELECT * FROM ".$query." WHERE 1=1 $iswhere AND ".$fwhere." AND (".$cari.")");
                }else{
                ...
                if(!empty($iswhere)){
                    $sql_filter = $this->db->query("SELECT * FROM ".$tables." WHERE 1=1 $iswhere AND ".$fwhere);
                }else{
