...
class UpdatePrice extends My_Controller
{
    ...
    public function index()
    {
        ...
        $data['title']          = 'Rambla | Perubahan Harga Hari Ini dan Besok';
        ...
        $this->load->view('laporan/perubahan-harga', $data);
    ...
    public function update_price_list()
    {
        ...
        $data = $this->M_UpdatePrice->getUpdatePrice($postData, $nonOffset);
    ...
    function export_csv_update_price()
    {
        ...
        $filename = 'update_price_'.date("Ymd").'.csv';
    ...
    function export_excel_update_price()
    {
        ...
        $filename = 'update_price_'.date("Ymd");
