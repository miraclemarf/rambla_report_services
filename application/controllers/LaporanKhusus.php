...
class LaporanKhusus extends My_Controller
{
    ...
    function export_excel_penjualanbrand($fromdate1, $todate1, $fromdate2, $todate2, $brand_code, $division, $sub_division, $dept, $sub_dept, $store)
    {
        ...
        foreach ($data as $key => $row) {
            ...
            $sheet->setCellValue('I' . $row_number, $row['Margin1']);
            $sheet->setCellValue('J' . $row_number, $row['LP_Sales2']);
            $sheet->setCellValue('K' . $row_number, $row['TP_Target2']);
            $sheet->setCellValue('L' . $row_number, $row['TP_Sales2']);
            $sheet->setCellValue('M' . $row_number, $row['Achieve2']);
            $sheet->setCellValue('N' . $row_number, $row['Growth2']);
            $sheet->setCellValue('O' . $row_number, $row['Margin2']);
            ...
            $sheet->setCellValue('U' . $row_number, $row['Margin3']);
            $row_number++;
        }
    ...
    function export_excel_penjualankategori($fromdate1, $todate1, $fromdate2, $todate2, $division, $sub_division, $store)
    {
        ...
        $sheet->setCellValue('H4', 'ATRIUM')->mergeCells('H4:M4');
        $sheet->setCellValue('H5', 'LP Sales');
        $sheet->setCellValue('I5', 'TP Target');
        $sheet->setCellValue('J5', 'TP Sales');
        $sheet->setCellValue('K5', '%Achieve');
        $sheet->setCellValue('L5', '%Growth	');
        $sheet->setCellValue('M5', '%Margin');
        $sheet->setCellValue('N4', 'TOTAL')->mergeCells('N4:S4');
        $sheet->setCellValue('N5', 'LP Sales');
        $sheet->setCellValue('O5', 'TP Target');
        $sheet->setCellValue('P5', 'TP Sales');
        $sheet->setCellValue('Q5', '%Achieve');
        $sheet->setCellValue('R5', '%Growth	');
        $sheet->setCellValue('S5', '%Margin');


        $sheet->getStyle('A4:U4')
            ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);

        $sheet->getStyle('B5:U5')
            ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
        ...
        foreach ($data as $key => $row) {
            ...
            $sheet->setCellValue('G' . $row_number, $row['Margin1']);
            $sheet->setCellValue('H' . $row_number, $row['LP_Sales2']);
            $sheet->setCellValue('I' . $row_number, $row['TP_Target2']);
            $sheet->setCellValue('J' . $row_number, $row['TP_Sales2']);
            $sheet->setCellValue('K' . $row_number, $row['Achieve2']);
            $sheet->setCellValue('L' . $row_number, $row['Growth2']);
            $sheet->setCellValue('M' . $row_number, $row['Margin2']);
            $sheet->setCellValue('N' . $row_number, $row['LP_Sales3']);
            $sheet->setCellValue('O' . $row_number, $row['TP_Target3']);
            $sheet->setCellValue('P' . $row_number, $row['TP_Sales3']);
            $sheet->setCellValue('Q' . $row_number, $row['Achieve3']);
            $sheet->setCellValue('R' . $row_number, $row['Growth3']);
            $sheet->setCellValue('S' . $row_number, $row['Margin3']);
            $row_number++;
        }

        $sheet->getStyle('A4:A' . $row_number . '')->getFont()->setBold(true);
        $sheet->getStyle('B4:S' . $row_number . '')->getNumberFormat()->setFormatCode('#');
        $sheet->getStyle('A4:S' . $row_number . '')->getBorders()->getAllBorders()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
        ...
        $sheet->getStyle('A' . $row_number . '')
            ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
        $sheet->getStyle('A' . $row_number . ':S' . $row_number . '')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
        $sheet->getStyle('A' . $row_number . ':S' . $row_number . '')->getFill()->getStartColor()->setRGB('FFF000');
