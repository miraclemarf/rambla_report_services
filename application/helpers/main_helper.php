<?php
	...
	function sql_datetime($date){ // yyyy-mm-dd
	...
	function indo_date2($date){ // yyyy-mm-dd
		$exp = date('d-M-y',strtotime($date));		
		return $exp;
	}
	
	function indo_date3($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('d F Y',strtotime($date));		
		return $exp;
	}
	
	function indo_date5($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('l,d F Y',strtotime($date));		
		return $exp;
	}
	
	function indo_date6($date){ // yyyy-mm-dd
		$exp = date('m/d/Y - m/d/Y',strtotime($date));		
		return $exp;
	}
	
	function jam($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('H:i',strtotime($date));		
		return $exp;
	}
	
	function jam2($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('h:i A',strtotime($date));		
		return $exp;
	}
	
	function jam3($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
	...
	function jam4($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('Y-m-d H:i',strtotime($date));		
		return $exp;
	}
	
	function menit($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('i',strtotime($date));		
		return $exp;
	}
	
	function indo_date4($date){ // yyyy-mm-dd 2015-10-27 00:00:00.000
		$date_now = date('d F Y');
	...
	function birthday($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('d F',strtotime($date));		
		return $exp;
	}
	
	function date_bootstrap($date){ // yyyy-mm-dd
		$exp = date('d/m/Y',strtotime($date));		
		return $exp;
	}
	
	function date_bootstrap2($date){ // yyyy-mm-dd
		$exp = date('m/d/Y',strtotime($date));		
		return $exp;
	}
	
	function aktivasi($date){ // yyyy-mm-dd
		$exp = date('Ymd',strtotime($date));		
		return $exp;
	}
	
	function ymdhis($date){ // yyyy-mm-dd
		$exp = date('YmdHis',strtotime($date));		
		return $exp;
	}
	
	function hari($date){ // yyyy-mm-dd
		//$exp = date('d F Y , H:i:s',strtotime($date));
		$exp = date('l',strtotime($date));		
		return $exp;
	}
	
	function tanggal($date){ // yyyy-mm-dd
		$exp = date('j',strtotime($date));		
		return $exp;
	}
	
	function bulan($date){ // yyyy-mm-dd
		$exp = date('m',strtotime($date));		
		return $exp;
	}

	function bln($date){ // yyyy-mm-dd
		$exp = date('F',strtotime($date));		
		return $exp;
	}
	
	function tahun($date){ // yyyy-mm-dd
	...
	function kunci($var){ // yyyy-mm-dd
		$key = md5($var);		
		return $key;
	}
	
	function password($var){ // yyyy-mm-dd
		$key = md5(md5(md5($var)));		
		return $key;
	}	
	...
	function inggris_date2($date){ // yyyy-mm-dd
		$exp = date('Y-m-d H:i:s',strtotime($date));		
		return $exp;
	}
