        ...
        <div class="modal-dialog vertical-align-center" role="document" style="width: 350px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="openModal">Filter Data Pembayaran Trx Online</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="filter-penjualanartikel">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <label class="mt-1">Delivery Type</label>
                                    </div>
                                    <div class="col-md-8">
                                        <select class="js-example-basic-single list_deltype">
                                        <option value=''>-- Pilih Data --</option>
                                        <option value="P">Pickup</option>
                                        <option value="R">Reguler</option>
                                        <option value="I">Instan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <label class="mt-1">Tipe Pembayaran</label>
                                    </div>
                                    <div class="col-md-8">
                                        <select class="js-example-basic-single list_paytype">
                                        <option value=''>-- Pilih Data --</option>
                                        <option value="VA">Virtual Account</option>
                                        <option value="VC">Voucher</option>
                                        <option value="PP">Point</option>
