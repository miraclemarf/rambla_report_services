<div class="modal fade" id="modal-filter-operationalfee" tabindex="-1" role="dialog" aria-labelledby="openModal" aria-hidden="true">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center" role="document" style="width: 350px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="openModal">Filter Laporan Operational Fee</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="filter-operationalfee">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="mt-1">Pilih Periode <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-md-8">
                                        <?php $this->load->view('elements/monthrange_picker'); ?>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-4">
