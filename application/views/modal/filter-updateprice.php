<div class="modal fade" id="modal-filter-penjualanartikel" tabindex="-1" role="dialog" aria-labelledby="openModal"
    aria-hidden="true">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center" role="document" style="width: 350px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="openModal">Filter Data</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="filter-penjualanartikel">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <label class="mt-1">Status Price</label>
                                    </div>
                                    <div class="col-md-8">
                                        <select class="js-example-basic-single list_price_status">
                                        <option value=''>-- Pilih Data --</option>
                                        <option value="=">Tetap</option>
                                        <option value=">">Naik</option>
                                        <option value="<">Turun</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
