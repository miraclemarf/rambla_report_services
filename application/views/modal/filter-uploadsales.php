<div class="modal fade" id="modal-filter-uploadsales" tabindex="-1" role="dialog" aria-labelledby="openModal" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="filter-uploadsales">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <label class="mt-1">Marketplace</label>
                                    </div>
                                    <div class="col-md-8">
                                        <select class="js-example-basic-single list_marketplace">
