<div class="modal fade" id="modal-filter-penjualanbybrand" tabindex="-1" role="dialog" aria-labelledby="openModal" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="filter-penjualanartikel">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <label class="mt-1">Pilih Brand <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-md-8">
